...
class it_top_ten extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		$numarticles = empty($numarticles) ? 10 : $numarticles;
		...
		#setup the query            
        $args=array('posts_per_page' => $numarticles, 'order' => 'DESC', 'orderby' => 'meta_value_num', 'meta_key' => IT_HEAT_INDEX, 'ignore_sticky_posts' => true, 'cat' => $selected_category, 'tag_id' => $selected_tag);
		
		#setup loop format
		$format = array('loop' => 'trending', 'location' => 'top ten', 'nonajax' => true, 'numarticles' => $numarticles, 'metric' => 'heat');	
		...
		$sortbarargs = array('title' => $title, 'loop' => 'trending', 'location' => 'top ten', 'cols' => 1, 'class' => '', 'disabled_filters' => $disabled_filters, 'numarticles' => $numarticles, 'disable_filters' => false, 'disable_title' => false, 'prefix' => false, 'thumbnail' => false, 'rating' => false, 'meta' => true, 'award' => false, 'badge' => false, 'excerpt' => false, 'authorship' => false, 'icon' => false, 'timeperiod' => $timeperiod, 'metric_text' => $default_label);
        ...
        #HTML output
		echo "<div class='post-container widget-panel widget-topten' data-currentquery='" . $current_query_encoded . "'>";
	...
	function form( $instance ) {	
		...
		$defaults = array( 'category' => 'All Categories', 'tag' => 'All Tags', 'numarticles' => 10, 'disable_heat' => false, 'disable_liked' => false, 'disable_viewed' => false, 'disable_reviewed' => false, 'disable_rated' => false, 'disable_commented' => false, 'timeperiod' => 'This Year' );		
		$instance = wp_parse_args( (array) $instance, $defaults ); ?>	
        
        <p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:',IT_TEXTDOMAIN); ?></label>
			<input id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" value="<?php echo $instance['title']; ?>" style="width:160px" /><br />
        ...
        <p>                
			...
			<?php _e( 'articles (default = 10)',IT_TEXTDOMAIN); ?>
		</p>
