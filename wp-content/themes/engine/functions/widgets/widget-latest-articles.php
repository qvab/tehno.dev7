...
class it_latest_articles extends WP_Widget {
	function __construct() {
		...
		/* Create the widget. */
		parent::__construct( 'it_latest_articles', 'Latest Articles', $widget_ops, $control_ops );
	}	
	function widget( $args, $instance ) {		
		...
		#setup sortbar
		$sortbarargs = array('title' => $title, 'loop' => $loop, 'location' => $location, 'layout' => $layout, 'disabled_filters' => array(), 'numarticles' => 0, 'disable_filters' => true, 'disable_title' => false, 'thumbnail' => true, 'meta' => true, 'icon' => true, 'award' => false, 'badge' => false, 'excerpt' => false, 'authorship' => false);
		...
		echo '<div class="post-container widget-panel compact-header ' . $style . '">';
