...
if ( ! function_exists( 'generate_add_footer_info' ) ) {
	...
	function generate_add_footer_info() {
		$copyright = sprintf( '<span class="copyright">&copy; %1$s %2$s</span> ',
			'2018 - ' . date( 'Y' ),
            'All Rights Reserved, Tehno.guru is a participant in the Amazon Services LLC Associates Program, an affiliate advertising program designed to provide a means for sites to earn advertising fees by advertising and linking to amazon.com and affiliated sites.'
		);
