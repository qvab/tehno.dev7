 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
     <table class="form-table">
        ...
        <?php _e( '- For further modifications the submit button is located at the end of the file <em>"cpcff_public_int.inc.php"</em>.', 'calculated-fields-form' ); ?><br />
		...
		<table class="form-table">
			<tr valign="top">
				...
				<td>
					...
					<br />
					<em><?php _e( '* Note: To change the text or design of the submit button go the latest lines of the file "cpcff_public_int.inc.php" or ovewrite the CSS styles of the ID #cp_subbtn { }', 'calculated-fields-form' ); ?></em>
				</td>
			</tr>
			<tr valign="top">
        ...
        <tr valign="top">
         ...
         <td colspan="2" rowspan="">
           <?php _e( 'Preview', 'calculated-fields-form' ); ?>:<br />
             <br />
            <img src="<?php echo (get_option('CP_CALCULATEDFIELDSF_CAPTCHA_DIRECT_MODE', false)) ?  plugins_url('../captcha/captcha.php', __FILE__) : CPCFF_AUXILIARY::wp_url(); ?>/?cp_calculatedfieldsf=captcha&inAdmin=1"  id="captchaimg" alt="security code" border="0"  />
         </td>
        </tr>
...
<script type="text/javascript">
	function generateCaptcha()
	{
	   ...
	   document.getElementById("captchaimg").src= "<?php echo (get_option('CP_CALCULATEDFIELDSF_CAPTCHA_DIRECT_MODE', false)) ?  plugins_url('../captcha/captcha.php', __FILE__) : CPCFF_AUXILIARY::wp_url(); ?>/?cp_calculatedfieldsf=captcha&inAdmin=1"+qs;
	}
