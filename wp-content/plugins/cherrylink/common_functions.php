...
function link_cf_where_show_pages($show_pages, $show_attachments='false') {
...
function link_cf_where_match_category() {
	global $wpdb, $wp_version;
	$cat_ids = '';
...
function link_cf_where_fulltext_match($weight_title, $titleterms, $weight_content, $contentterms, $weight_tags, $tagterms) {
	$wsql = array();
...
function link_cf_score_fulltext_match($table_name, $weight_title, $titleterms, $weight_content, $contentterms, $weight_tags, $tagterms, $forced_ids='') {
	global $wpdb;
	$wsql = array();
