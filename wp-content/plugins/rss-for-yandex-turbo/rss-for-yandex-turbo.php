...
<h2><?php _e('Настройки плагина &#8220;Яндекс.Турбо&#8220;', 'rss-for-yandex-turbo'); ?><span id="restore-hide-blocks" class="dashicons dashicons-align-left hide" title="<?php _e('Восстановить скрытые блоки', 'rss-for-yandex-turbo'); ?>"></span></h2>
...
if (closedonat == 'yes') {
    ...
    document.getElementById('restore-hide-blocks').className = 'dashicons dashicons-align-left';
}
</script>
