...
jQuery(document).ready(function($) {
	if ( typeof tocplus != 'undefined' ) {
		...
		if ( typeof tocplus.visibility_show != 'undefined' ) {
			...
			console.log($.cookie("wp-wpml_current_language"));

			if ($.cookie("wp-wpml_current_language") !== "en") {
        tocplus.visibility_show = "Показать";
        tocplus.visibility_hide = "Скрыть";
			} else {
        tocplus.visibility_show = "Show";
        tocplus.visibility_hide = "Hide";
			}
