...
class WPSEO_OpenGraph {
	...
	public function replace_upl_rom_name( $pre_option, $option, $default ){
	    include_once $_SERVER["DOCUMENT_ROOT"]."/mishanin_log.php";
	    mishaninLog(json_encode(["pre_option" => $pre_option, "option" => $option, "default" => $default], JSON_UNESCAPED_UNICODE));
    }
	/**
	 * Class constructor.
	 */
	public function __construct() {
        add_filter("pre_option_ulp_from_name", [$this, "replace_upl_rom_name"], 10, 3);
	...
	public function description( $echo = true ) {
		...
		// TODO mishanin
        $ogdesc = "Tools & Home Improvement
Description: All you want to know about tools & home improvement. Interesting articles and reviews.";
